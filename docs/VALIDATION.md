...
- public annotated GitHub release, exact tag-to-deployed-commit identity, hosted app/Core manifest,
  public README portfolio block, and deployed app footer agreement;
